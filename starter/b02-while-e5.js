...
let lettre = prompt("Veuillez saisir la lettre 'X'");

while (lettre !== 'X'){
    lettre = prompt("Veuillez saisir la lettre 'X'");
}
...
let lettres = prompt("Veuillez saisir la lettre 'X'");
let concatenation = '';

while (lettres !== 'X'){
    lettres = prompt("Veuillez saisir la lettre 'X'");
    concatenation += lettres;
}
